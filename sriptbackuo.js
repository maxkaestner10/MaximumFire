...
// Berechnet immer 7 Tage: die letzten 6 Tage + heute (inkl. Vor/Zurück-Offset)
function getWeekDates(){
    let days = [];
    let today = new Date();

    let endDate = new Date(today);
    endDate.setDate(today.getDate() + (currentWeekOffset * 7));

    // 6 Tage zurückgehen bis zum aktuellen Enddatum
    for(let i = 6; i >= 0; i--){
